 ...
 */
final class Version20200305131315 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE user_id user_id INT DEFAULT NULL, CHANGE price price NUMERIC(4, 2) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
